...
def load_data(request, accion):
    if request.user.is_superuser:
        ...
        elif accion == "analisis_partidas_equipos_1":
            try:
                file = open(os.path.abspath(os.path.dirname(__file__)) + "/data/" + "PAREQUIPOS_1.txt", "r", errors='replace')
                lines = file.readlines()
        ...
        elif accion == "analisis_partidas_equipos_2":
            try:
                file = open(os.path.abspath(os.path.dirname(__file__)) + "/data/" + "PAREQUIPOS_2.txt", "r", errors='replace')
                lines = file.readlines()
        ...
        elif accion == "analisis_partidas_personal_1":
            try:
                file = open(os.path.abspath(os.path.dirname(__file__)) + "/data/" + "PARPERSONAL_1.txt", "r", errors='replace')
                lines = file.readlines()
        ...
        elif accion == "analisis_partidas_personal_2":
            try:
                file = open(os.path.abspath(os.path.dirname(__file__)) + "/data/" + "PARPERSONAL_2.txt", "r", errors='replace')
                lines = file.readlines()
